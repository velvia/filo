...
public final class DiffPrimitiveVector extends Table {
  ...
  public long base() { int o = __offset(8); return o != 0 ? bb.getLong(o + bb_pos) : 0; }
  public DataInfo info() { return info(new DataInfo()); }
  public DataInfo info(DataInfo obj) { int o = __offset(10); return o != 0 ? obj.__init(o + bb_pos, bb) : null; }
  public int data(int j) { int o = __offset(12); return o != 0 ? bb.get(__vector(o) + j * 1) & 0xFF : 0; }
  ...
  public static void startDiffPrimitiveVector(FlatBufferBuilder builder) { builder.startObject(5); }
  ...
  public static void addBase(FlatBufferBuilder builder, long base) { builder.addLong(2, base, 0); }
  public static void addInfo(FlatBufferBuilder builder, int infoOffset) { builder.addStruct(3, infoOffset, 0); }
